...
const Login = () => {
  ...
  // use effect hook
  /* The reason of using useEffect here is because we don't want passwordState.value.trim()... in emailChangeHandler
  PasswordChangeHandler ... because it may be getting older state for some reason */
  useEffect(() => {
  ...
  const submitHandler = (event) => {
    ...
    ctxValue.onLogin(emailState.value, passwordState);
  };
